  ...
  void makeShape() {
    if (type==1) {
      if (otion==1) {
        ...
        blocks[0] = new Block(new PVector(pivLoc.x, pivLoc.y-space), c, 0);
      ...
      if (otion==1) {
        ...
        blocks[0] = new Block(new PVector(pivLoc.x, pivLoc.y-space), c, 0);
        blocks[2] = new Block(new PVector(pivLoc.x, pivLoc.y+space), c, 2);
        blocks[3] = new Block(new PVector(pivLoc.x, pivLoc.y+2*space), c, 3);
      }
    } else if (type==2) {
      if (otion==1) {
        blocks[0] = new Block(new PVector(pivLoc.x+space, pivLoc.y), c, 0);
      ...
      if (otion==1) {
        ...
        blocks[0] = new Block(new PVector(pivLoc.x, pivLoc.y-space), c, 0);
        blocks[2] = new Block(new PVector(pivLoc.x, pivLoc.y+space), c, 2);
        blocks[3] = new Block(new PVector(pivLoc.x-space, pivLoc.y), c, 3);
      } else if (otion==3) {
        blocks[0] = new Block(new PVector(pivLoc.x+space, pivLoc.y), c, 0);
        blocks[2] = new Block(new PVector(pivLoc.x-space, pivLoc.y), c, 2);
        blocks[3] = new Block(new PVector(pivLoc.x, pivLoc.y-space), c, 3);
